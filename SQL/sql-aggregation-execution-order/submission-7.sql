...
where category != 'Gymnastics' group by country,year 
having sum(gold+silver+bronze) > 20 order by total_medals desc
limit 5;

SELECT country, year, total_medals
FROM (
    SELECT 
        country, 
        year, 
